...
def _agent_and_runner(tmp_path, monkeypatch, calls):
    ...
    monkeypatch.setattr(runner, "_maybe_microcompact", lambda m, s, tokens=None, cancellation_token=None: (m, s))
    monkeypatch.setattr(runner, "_maybe_full_compress", lambda m, s, tokens=None, cancellation_token=None: (m, s))
