...
- [**5.1 Custom Tools & Host Injection**](./1-custom-tools) — write tools, inject/select the tool surface, and avoid common pitfalls
...
|-----------------------|------------------|------------------------|
| Let the agent call your business API | [5.1](./1-custom-tools) → [5.4](./4-permissions) | Write and inject a Tool, then add confirmation or permission boundaries for side effects |
| Select / shrink the tool surface from the host | [5.1](./1-custom-tools) | Inject, replace, or prune tools at construction or runtime — and know it's not a security boundary |
