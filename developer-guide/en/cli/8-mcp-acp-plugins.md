...
- Plugins: `PluginManager` — the diagnostic report is generated by `agentao.plugins.diagnostics.build_diagnostics`, which a host can also invoke. See [Part 5.7](/en/part-5/7-plugin-hooks) for the full programmatic interface.
:::
