...
| Headless runtime | 无头运行时 | 把 Agentao 作为非交互 embedding 目标运行——`ACPManager` 驱动 ACP 服务器，`get_status()` 返回类型化快照，全程无需人工介入。见 [`docs/guides/headless-runtime.md`](../../../docs/guides/headless-runtime.md)。 |
