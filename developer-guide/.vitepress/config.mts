...
const zhSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '4.8 编排续航', link: '/zh/part-4/8-orchestration-continuation' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { text: '7.7 多 Agent 看板调度', link: '/zh/part-7/7-kanban-multiagent' },
    ],
  },
  {
    text: '附录',
...
const enSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '4.8 Orchestration Continuation', link: '/en/part-4/8-orchestration-continuation' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { text: '7.7 Multi-Agent Kanban Scheduling', link: '/en/part-7/7-kanban-multiagent' },
    ],
  },
  {
    text: 'Appendix',
