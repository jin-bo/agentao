...
- Full embedding reference: [`docs/EMBEDDING.md`](EMBEDDING.md)
- Stable host API: [`docs/api/host.md`](api/host.md)
- Design / stability boundary: [`docs/design/embedded-host-contract.md`](design/embedded-host-contract.md)
- Non-Python hosts (stdio): [`docs/ACP.md`](ACP.md)
...
| You only need **non-interactive automation** (run a prompt, get exit code) | `agentao run --prompt "..."` | [`docs/CONFIGURATION.md`](CONFIGURATION.md), `agentao/cli/run.py` |
| You want Agentao to **drive other agents** (Claude Code, Codex) as backends | ACP client | [`features/acp-client.md`](features/acp-client.md) |
...
Delivery contract (full version in [`api/host.md`](api/host.md)):
...
reference is [`docs/api/host.md`](api/host.md); for everything not
covered here, [`docs/EMBEDDING.md`](EMBEDDING.md).
