...
计划。**~~ **它已获批准并实施:AC1–AC8 于 2026-07-23/24 落地(PR #137 + #138,
`a6b1b9e`),随 0.4.16 发布** —— AC8 部分完成,AC4 重新界定范围;见下文
「实施状态」一节,那才是权威记录,而且从本抬头写下的次日起就这么写着。
该子包**不在** 2026-06-19 `optimization-opportunities-review.md` 的审计
