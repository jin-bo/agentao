...
而 rev 19 是一遍编辑性整理、rev 32 与 rev 42 是结构修订、rev 45 是 PR-4 的实施轮，都不是一轮评审** —— 这就是「rev 2–45 那四十四行、合计三百二十一条」与「表头写
