...
**Status:** **implemented 2026-09-18** (PR #292), authorized the same day; **shipped in 0.5.0**. Inventory measured against `main@2f51570` on 2026-09-18; every row below was
