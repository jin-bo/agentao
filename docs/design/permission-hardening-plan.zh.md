...
**状态：** 实施计划，rev 3。2026-05-03 起草，跨 4 轮评审。**PR 1（P0 正确性修复）、PR 2（P1 可选 hardline 层）、PR 3–5（P2/P3 便利项与敏感写入预设）均已于 2026-05-04 全部合入，并**随 0.4.3 发布**。** 本计划已收口；后续加固工作另行追踪。详见 §9 各 PR 落点；§10 保留遗留的开放追踪项（主要是 PR 5 正则层向 `bashlex` 解析的演进）。
