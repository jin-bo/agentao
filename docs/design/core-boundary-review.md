...
> **Status, 2026-05-07:** items #1, #2 (constructor callback tightening), #3 (session.py migration), #4 (permission engine API redesign) shipped. Commits: `838a952` (#3), `0310eda` (#1), `e467c95` (#2), `<#4-pending>` (#4). Original priority table preserved below; checkboxes added.
