...
> **Status, 2026-05-07:** items #1, #2 (constructor callback tightening), #3 (session.py migration) shipped. #4 (permission engine API redesign) still pending. Commits: `838a952` (#3), `0310eda` (#1), `<pending>` (#2). Original priority table preserved below; checkboxes added.
