...
1. [Phase 1: Manifest And Loader](plugin-system-mvp/phase-1-manifest-and-loader.md)
2. [Phase 2: Skills And Commands](plugin-system-mvp/phase-2-skills-and-commands.md)
3. [Phase 3: Agents](plugin-system-mvp/phase-3-agents.md)
4. [Phase 4: MCP Integration](plugin-system-mvp/phase-4-mcp-integration.md)
5. [Phase 5: UserPromptSubmit And Hook Core](plugin-system-mvp/phase-5-user-prompt-submit-and-hook-core.md)
6. [Phase 6: Session Tool Hooks And CLI Diagnostics](plugin-system-mvp/phase-6-session-tool-hooks-and-cli.md)
