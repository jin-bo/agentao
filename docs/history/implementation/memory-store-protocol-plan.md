...
**Source epic:** [`EMBEDDED_HARNESS_GITHUB_EPIC.md`](embedded-harness-github-epic.md) — Issue 10 (became GitHub #16)
**Strategy doc:** [`EMBEDDED_HARNESS_IMPLEMENTATION_PLAN.md`](embedded-harness-implementation-plan.md)
**Milestone:** M5 of the embedded-harness epic — bundles with Issues #17 (`MCPRegistry`) and #18 (`docs/guides/embedding.md`) to cut `0.3.0`
