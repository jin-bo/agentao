...
[`kanban-acp-embedded-client-issue.md`](../history/kanban-acp-embedded-client-issue.md)
and [`implementation/ACP_EMBEDDING_IMPLEMENTATION_PLAN.md`](../history/implementation/acp-embedding-implementation-plan.md).
