...
**[docs/guides/embedding.md §2 → "Optional: silencing or redirecting agentao.log"](embedding.md#optional-silencing-or-redirecting-agentaolog)**。
...
> **[docs/guides/embedding.md](embedding.md)**。
