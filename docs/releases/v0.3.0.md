...
and `docs/guides/embedding.md` lands as the single entry point for hosts
...
- **`docs/guides/embedding.md`** (Issue #18). Single canonical guide for
...
6. Close GitHub issues #14 (hard break — `working_directory=`
   ...
   Protocol), and #18 (`docs/guides/embedding.md` + example sweep) once the
   release is on PyPI.
