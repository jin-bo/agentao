...
- `docs/guides/acp.md` version examples aligned to `0.2.13`
- README and `docs/start/quickstart.md` Quick Start now list all three
...
- `docs/guides/skills.md` and `developer-guide/en|zh/part-5/2-skills.md`
