...
| [design/compaction-orchestration-plan.md](design/compaction-orchestration-plan.md) | Six-PR plan converging the five compaction entry points behind one coordinator (`.zh.md` twin). Reviewed twelve times; **implemented 2026-08-24** — all six PRs merged (#187–#192), unreleased |
