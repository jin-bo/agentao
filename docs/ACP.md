...
ACP support landed across `docs/implementation/acp-issues/01` through `14`. Tests live in `tests/test_acp_*.py`. Version examples below track the current release line (`0.2.9` as of this document revision).
...
```json
{"jsonrpc":"2.0","id":1,"result":{"protocolVersion":1,"agentCapabilities":{"loadSession":true,"promptCapabilities":{"image":false,"audio":false,"embeddedContext":false},"mcpCapabilities":{"http":false,"sse":true}},"authMethods":[],"agentInfo":{"name":"agentao","title":"Agentao","version":"0.2.9"}}}
...
← {"jsonrpc":"2.0","id":1,"result":{
    ...
    "authMethods":[],
    "agentInfo":{"name":"agentao","title":"Agentao","version":"0.2.9"}
  }}
