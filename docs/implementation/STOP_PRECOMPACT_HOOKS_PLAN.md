...
- `docs/implementation/plugin-system-mvp/PHASE_6_SESSION_TOOL_HOOKS_AND_CLI.md` — append the two new events to the supported list.
- `docs/CONFIGURATION.md` — if it enumerates hook events anywhere, sync the list.
