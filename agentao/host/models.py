"""Public Pydantic payload models for the ``agentao.host`` contract.

These models are the host-facing compatibility boundary: adding optional
fields is backwards-compatible; removing a field, renaming a field,
changing enum values, or changing field semantics requires a schema
version bump.
