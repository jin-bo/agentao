...
- **Left out:** host tools, including one that replaced a built-in (told apart by class identity, and never swapped back for the built-in), agent tools and plan tools.
